...
| FemtoRV tutorial | BSD-3-Clause | validação | contadores, sequenciador de memória, decodificador, máquina de estados, ALU, macros de assembly, saltos e desvios RISC-V |
...
No corpus externo v26 atual, a contagem é 26/10/20; os déficits são 74/10/0. A
