...
| FemtoRV tutorial | BSD-3-Clause | validação | contadores, sequenciador de memória, decodificador, máquina de estados, ALU, macros de assembly e saltos RISC-V |
...
No corpus externo v25 atual, a contagem é 26/9/20; os déficits são 74/11/0. A
