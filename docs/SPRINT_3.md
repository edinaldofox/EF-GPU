...
| FemtoRV tutorial | BSD-3-Clause | validação | contadores, sequenciador de memória, decodificador, máquina de estados e ALU RISC-V |
...
No corpus externo v23 atual, a contagem é 26/7/20; os déficits são 74/13/0. A
