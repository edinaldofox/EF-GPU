...
| FemtoRV tutorial | BSD-3-Clause | validação | contadores, sequenciador de memória, decodificador, máquina de estados, ALU, macros de assembly, saltos, desvios e imediatos superiores RISC-V |
...
No corpus externo v27 atual, a contagem é 26/11/20; os déficits são 74/9/0. A
