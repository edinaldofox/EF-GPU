...
| --- | --- | --- | --- |
| SERV | ISC | treino | ALU serial, alinhador, RAM de registradores em seis larguras e buffer de dados/shift |
...
No corpus externo v16 atual, a contagem é 19/5/20; os déficits são 81/15/0. A
