...
EXAMPLES: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "femtorv-step10-001", "source_id": "learn-fpga", "split": "validation", "design_family": "femtorv_tutorial_upper_immediate_writeback", "source_path": "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/step10.v", "dependencies": ("FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/riscv_assembly.v", "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/clockworks.v", "FemtoRV/RTL/PLL/femtopll.v"), "testbench": "tests/external/femtorv/tb_femtorv_step10.v", "specification": "Implement the pinned FemtoRV tutorial LUI/AUIPC writeback selection and upper-immediate assembly program.", "verification_command": "./scripts/verify-external-rtl.sh learn-fpga && ./scripts/synth-external-rtl.sh learn-fpga SOC_step10"},
    {
        ...
        "id": "femtorv-step8-001", "source_id": "learn-fpga", "split": "validation", "design_family": "femtorv_tutorial_jump_control_flow", "source_path": "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/step8.v", "dependencies": ("FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/riscv_assembly.v", "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/clockworks.v", "FemtoRV/RTL/PLL/femtopll.v"), "testbench": "tests/external/femtorv/tb_femtorv_step8.v", "specification": "Implement the pinned FemtoRV tutorial JAL/JALR next-PC control with label-encoded assembly program.", "verification_command": "./scripts/verify-external-rtl.sh learn-fpga && ./scripts/synth-external-rtl.sh learn-fpga SOC_step8"},
    {
        ...
        "source_id": "learn-fpga",
        "split": "validation",
        "design_family": "femtorv_tutorial_assembly_macro_alu_program",
        "source_path": "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/step7.v",
        "dependencies": ("FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/riscv_assembly.v", "FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV/clockworks.v", "FemtoRV/RTL/PLL/femtopll.v"),
        "testbench": "tests/external/femtorv/tb_femtorv_step7.v",
        "specification": "Implement the pinned FemtoRV tutorial ALU program encoded through reviewed RISC-V assembly macros and word-addressed instruction fetch.",
        "verification_command": "./scripts/verify-external-rtl.sh learn-fpga && ./scripts/synth-external-rtl.sh learn-fpga SOC_step7",
    },
    {
